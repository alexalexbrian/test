...
<main class="container">
  <h3> Add categorías <small style="font-size: 12px;">bd_categoria_edit.blade.php</small></h3>
<x-flash/>
<!--Codigo php en Blade-->
@php
...
<form action="{{route('bd_categorias_edit_post',['id'=>$categoria->id])}}" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="nombre" id="nombre" class="form-control" placeholder="" aria-describedby="helpId" value="{{$categoria->nombre}}">
